...
<html class="   ">
  <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# object: http://ogp.me/ns/object# article: http://ogp.me/ns/article# profile: http://ogp.me/ns/profile#">
    ...
    <title>magic3d/Src/Math/HomoMatrix3.h at master · magic3dcn/magic3d</title>
...
<meta content="GitHub" property="og:site_name" /><meta content="object" property="og:type" /><meta content="https://avatars3.githubusercontent.com/u/6185106?s=400" property="og:image" /><meta content="magic3dcn/magic3d" property="og:title" /><meta content="https://github.com/magic3dcn/magic3d" property="og:url" /><meta content="magic3d - Magic3D is a platform for developing graphics and vision related cutting-edge technology, including but not limited: 3D scanning, reconstruction, modeling, image processing." property="og:description" />
    ...
    <meta content="collector.githubapp.com" name="octolytics-host" /><meta content="collector-cdn.github.com" name="octolytics-script-host" /><meta content="github" name="octolytics-app-id" /><meta content="70413EFA:159D:A115B50:5379F547" name="octolytics-dimension-request_id" /><meta content="6185670" name="octolytics-actor-id" /><meta content="liguocn" name="octolytics-actor-login" /><meta content="ae2cdcc2cad20d6cb26b862a0d98585e6d3e956a9ed4a28545006cc3f655d3c6" name="octolytics-actor-hash" />
...
<meta content="uIbVmETVvxrUvIv+GXqbqjwLYBn7TExsMnfcLZ+AAwh5kQSi3RroQZtnohZFwkuQlisLeEjriL6zktB4L8OIDg==" name="csrf-token" />
...
<ul class="pagehead-actions">
    ...
    <li class="subscription">
      <form accept-charset="UTF-8" action="/notifications/subscribe" class="js-social-container" data-autosubmit="true" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="authenticity_token" type="hidden" value="ioVofWwEZiO/xHyQsvx+Ax/eNKIXty/9pk9reY8kENtipGa247cSjNO7qA801Vh77472BYXwxd0lUnBiP2Rc4w==" /></div>  <input id="repository_id" name="repository_id" type="hidden" value="15197513" />
  ...
  <div class="js-toggler-container js-social-container starring-container ">
    ...
    <form accept-charset="UTF-8" action="/magic3dcn/magic3d/unstar" class="js-toggler-form starred" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="authenticity_token" type="hidden" value="EXcUOympwYDcD0/+ii49zJV8/IkcTkd73wdLqSW3dPYj5g4V5ksBaoqblmIYUH+t9XkXNLrFFbdbLGBLUejaqA==" /></div>
      <button
    ...
    <form accept-charset="UTF-8" action="/magic3dcn/magic3d/star" class="js-toggler-form unstarred" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="authenticity_token" type="hidden" value="Bxc8eT+8I4Q0uAaK7/gWj6uoB2t5eMmqV/xQif+pVMEG7e24GajzAtnnUS3OnCEcmR+zXfg8IYBgy9orG9Yzrw==" /></div>
      <button
        class="minibutton with-count js-toggler-target star-button"
...
<a href="/magic3dcn/magic3d/blob/f6481afa804745cdc4681bee1f541ebad661d8be/Src/Math/HomoMatrix3.h" class="hidden js-permalink-shortcut" data-hotkey="y">Permalink</a>

<!-- blob contrib key: blob_contributors:v21:d99aa098e8118d8a2be3a1e925e4f13f -->
    ...
    <div class="select-menu-modal">
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="branches">
        ...
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/magic3dcn/magic3d/blob/develop/Src/Math/HomoMatrix3.h"
                 data-name="develop"
                 data-skip-pjax="true"
                 rel="nofollow"
            ...
            <div class="select-menu-item js-navigation-item selected">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/magic3dcn/magic3d/blob/master/Src/Math/HomoMatrix3.h"
                 data-name="master"
                 data-skip-pjax="true"
                 rel="nofollow"
                 class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target"
          ...
          <form accept-charset="UTF-8" action="/magic3dcn/magic3d/branches" class="js-create-branch select-menu-item select-menu-new-item-form js-navigation-item js-new-item-form" method="post"><div style="margin:0;padding:0;display:inline"><input name="authenticity_token" type="hidden" value="4NpjhxSWKSnGeOX9IhyAd3X72BpKynQPy9/268KSVpD/DiyxWRYD5dtALD9nqpY+PwkgN8Ka8HQ8Aw6c0QLzXw==" /></div>
            ...
            <input type="hidden" name="path" id="path" value="Src/Math/HomoMatrix3.h" />
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="tags">
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/magic3dcn/magic3d/tree/v0.4/Src/Math/HomoMatrix3.h"
                 data-name="v0.4"
                 data-skip-pjax="true"
                 rel="nofollow"
                 class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target"
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/magic3dcn/magic3d/tree/V0.6.1/Src/Math/HomoMatrix3.h"
                 data-name="V0.6.1"
                 data-skip-pjax="true"
                 rel="nofollow"
                 class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target"
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/magic3dcn/magic3d/tree/V0.5/Src/Math/HomoMatrix3.h"
                 data-name="V0.5"
                 data-skip-pjax="true"
                 rel="nofollow"
                 class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target"
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/magic3dcn/magic3d/tree/ReliefFromMesh3D/Src/Math/HomoMatrix3.h"
      ...
      <div class="actions">
        <div class="button-group">
            <a class="minibutton tooltipped tooltipped-w js-conduit-openfile-check"
               ...
               data-url="github-mac://openRepo/https://github.com/magic3dcn/magic3d?branch=master&amp;filepath=Src%2FMath%2FHomoMatrix3.h"
               aria-label="Open this file in GitHub for Mac"
               data-failed-title="Your version of GitHub for Mac is too old to open this file. Try checking for updates.">
                <span class="octicon octicon-device-desktop"></span> Open
            </a>
                <a class="minibutton js-update-url-with-hash"
                   href="/magic3dcn/magic3d/edit/master/Src/Math/HomoMatrix3.h"
                   data-method="post" rel="nofollow" data-hotkey="e">Edit</a>
          <a href="/magic3dcn/magic3d/raw/master/Src/Math/HomoMatrix3.h" class="button minibutton " id="raw-url">Raw</a>
            <a href="/magic3dcn/magic3d/blame/master/Src/Math/HomoMatrix3.h" class="button minibutton js-update-url-with-hash">Blame</a>
          <a href="/magic3dcn/magic3d/commits/master/Src/Math/HomoMatrix3.h" class="button minibutton " rel="nofollow">History</a>
        </div><!-- /.button-group -->

            <a class="minibutton danger empty-icon"
               href="/magic3dcn/magic3d/delete/master/Src/Math/HomoMatrix3.h"
...
<span id="L27" rel="#L27">27</span>
            ...
            <td class="blob-line-code"><div class="code-body highlight"><pre><div class='line' id='LC1'><span class="cp">#pragma once</span></div><div class='line' id='LC2'><br/></div><div class='line' id='LC3'><span class="k">namespace</span> <span class="n">MagicMath</span></div><div class='line' id='LC4'><span class="p">{</span></div><div class='line' id='LC5'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="k">class</span> <span class="nc">HomoMatrix3</span></div><div class='line' id='LC6'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="p">{</span></div><div class='line' id='LC7'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="nl">public:</span></div><div class='line' id='LC8'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="n">HomoMatrix3</span><span class="p">();</span></div><div class='line' id='LC9'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="o">~</span><span class="n">HomoMatrix3</span><span class="p">();</span></div><div class='line' id='LC10'><br/></div><div class='line' id='LC11'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="kt">void</span> <span class="n">Print</span><span class="p">()</span> <span class="k">const</span><span class="p">;</span></div><div class='line' id='LC12'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="kt">void</span> <span class="n">TransformPoint</span><span class="p">(</span><span class="kt">double</span> <span class="n">x</span><span class="p">,</span> <span class="kt">double</span> <span class="n">y</span><span class="p">,</span> <span class="kt">double</span><span class="o">&amp;</span> <span class="n">resX</span><span class="p">,</span> <span class="kt">double</span><span class="o">&amp;</span> <span class="n">resY</span><span class="p">)</span> <span class="k">const</span><span class="p">;</span></div><div class='line' id='LC13'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="kt">void</span> <span class="nf">GenerateTranslation</span><span class="p">(</span><span class="kt">double</span> <span class="n">deltaX</span><span class="p">,</span> <span class="kt">double</span> <span class="n">deltaY</span><span class="p">);</span></div><div class='line' id='LC14'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="kt">void</span> <span class="nf">GenerateRotation</span><span class="p">(</span><span class="kt">double</span> <span class="n">theta</span><span class="p">);</span> <span class="c1">//counterclockwise</span></div><div class='line' id='LC15'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="kt">void</span> <span class="nf">GenerateScaling</span><span class="p">(</span><span class="kt">double</span> <span class="n">scaleX</span><span class="p">,</span> <span class="kt">double</span> <span class="n">scaleY</span><span class="p">);</span></div><div class='line' id='LC16'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="kt">void</span> <span class="nf">Unit</span><span class="p">(</span><span class="kt">void</span><span class="p">);</span></div><div class='line' id='LC17'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="n">HomoMatrix3</span> <span class="nf">ReverseRigidTransform</span><span class="p">(</span><span class="kt">void</span><span class="p">);</span></div><div class='line' id='LC18'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="n">HomoMatrix3</span> <span class="k">operator</span> <span class="o">*</span> <span class="p">(</span><span class="k">const</span> <span class="n">HomoMatrix3</span><span class="o">&amp;</span> <span class="n">mat</span><span class="p">)</span> <span class="k">const</span><span class="p">;</span></div><div class='line' id='LC19'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="n">HomoMatrix3</span> <span class="k">operator</span> <span class="o">*=</span> <span class="p">(</span><span class="k">const</span> <span class="n">HomoMatrix3</span><span class="o">&amp;</span> <span class="n">mat</span><span class="p">);</span></div><div class='line' id='LC20'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="kt">double</span> <span class="n">GetValue</span><span class="p">(</span><span class="kt">int</span> <span class="n">row</span><span class="p">,</span> <span class="kt">int</span> <span class="n">col</span><span class="p">)</span> <span class="k">const</span><span class="p">;</span></div><div class='line' id='LC21'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="kt">void</span> <span class="nf">SetValue</span><span class="p">(</span><span class="kt">int</span> <span class="n">row</span><span class="p">,</span> <span class="kt">int</span> <span class="n">col</span><span class="p">,</span> <span class="kt">double</span> <span class="n">v</span><span class="p">);</span></div><div class='line' id='LC22'><br/></div><div class='line' id='LC23'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="nl">private:</span></div><div class='line' id='LC24'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="kt">double</span> <span class="n">mValues</span><span class="p">[</span><span class="mi">9</span><span class="p">];</span></div><div class='line' id='LC25'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="p">};</span></div><div class='line' id='LC26'><br/></div><div class='line' id='LC27'><span class="p">}</span></div></pre></div></td>
          </tr>
        </table>
  </div>
...
<div id="jump-to-line" style="display:none">
  ...
  <div class="site-footer">
    ...
    <ul class="site-footer-links">
      <li>&copy; 2014 <span title="0.05995s from github-fe125-cp1-prd.iad.github.net">GitHub</span>, Inc.</li>
