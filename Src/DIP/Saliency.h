...
<html class="   ">
  <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# object: http://ogp.me/ns/object# article: http://ogp.me/ns/article# profile: http://ogp.me/ns/profile#">
    ...
    <title>magic3d/Src/DIP/Saliency.h at master · magic3dcn/magic3d</title>
...
<meta content="GitHub" property="og:site_name" /><meta content="object" property="og:type" /><meta content="https://avatars3.githubusercontent.com/u/6185106?s=400" property="og:image" /><meta content="magic3dcn/magic3d" property="og:title" /><meta content="https://github.com/magic3dcn/magic3d" property="og:url" /><meta content="magic3d - Magic3D is a platform for developing graphics and vision related cutting-edge technology, including but not limited: 3D scanning, reconstruction, modeling, image processing." property="og:description" />
    ...
    <meta content="collector.githubapp.com" name="octolytics-host" /><meta content="collector-cdn.github.com" name="octolytics-script-host" /><meta content="github" name="octolytics-app-id" /><meta content="70413EFA:159E:2A5272F:5379EF5B" name="octolytics-dimension-request_id" /><meta content="6185670" name="octolytics-actor-id" /><meta content="liguocn" name="octolytics-actor-login" /><meta content="ae2cdcc2cad20d6cb26b862a0d98585e6d3e956a9ed4a28545006cc3f655d3c6" name="octolytics-actor-hash" />
...
<meta content="501YwX0xjMVqPvPseZTDK2hy4HHIY46jJ9QFKYElFTC5AcnJ1io/GmME/4OEotxYKi7SbzuTcplrmlhxbNVwAQ==" name="csrf-token" />
...
<ul class="pagehead-actions">
    ...
    <li class="subscription">
      <form accept-charset="UTF-8" action="/notifications/subscribe" class="js-social-container" data-autosubmit="true" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="authenticity_token" type="hidden" value="rw3I5RExQrcAPC0AkXb+gRF/r87JdUJSp9bnHxe/3h2o3+aPjKMj9c9EnBCb/WP0ttaGxFqS8pIvpr8JX26oXQ==" /></div>  <input id="repository_id" name="repository_id" type="hidden" value="15197513" />
  ...
  <div class="js-toggler-container js-social-container starring-container ">
    ...
    <form accept-charset="UTF-8" action="/magic3dcn/magic3d/unstar" class="js-toggler-form starred" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="authenticity_token" type="hidden" value="kv6GbyV3GwkYv0ddwZ5XQL1XliYY3sd8LGIC7JpFKxieW6S+AABsjV/uKQyt5BQ2cOsLtzPpavsplw77EUDgnA==" /></div>
      <button
    ...
    <form accept-charset="UTF-8" action="/magic3dcn/magic3d/star" class="js-toggler-form unstarred" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="authenticity_token" type="hidden" value="KsOPYhofeRexeHOXVfvr0kaBrHVrxeuz23HcQlRHNOybRp4UA1MtTh9K5AQmZbHtVYX2/J9ACYp7AFookn8EAg==" /></div>
      <button
        class="minibutton with-count js-toggler-target star-button"
...
<a href="/magic3dcn/magic3d/blob/f6481afa804745cdc4681bee1f541ebad661d8be/Src/DIP/Saliency.h" class="hidden js-permalink-shortcut" data-hotkey="y">Permalink</a>

<!-- blob contrib key: blob_contributors:v21:d867c40f67f678e2ab63df17da83231a -->
    ...
    <div class="select-menu-modal">
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="branches">
        ...
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/magic3dcn/magic3d/blob/develop/Src/DIP/Saliency.h"
                 data-name="develop"
                 data-skip-pjax="true"
                 rel="nofollow"
            ...
            <div class="select-menu-item js-navigation-item selected">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/magic3dcn/magic3d/blob/master/Src/DIP/Saliency.h"
                 data-name="master"
                 data-skip-pjax="true"
                 rel="nofollow"
                 class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target"
          ...
          <form accept-charset="UTF-8" action="/magic3dcn/magic3d/branches" class="js-create-branch select-menu-item select-menu-new-item-form js-navigation-item js-new-item-form" method="post"><div style="margin:0;padding:0;display:inline"><input name="authenticity_token" type="hidden" value="7wwnEWF6H7LZA2Cv1Udatzy7Vm9KQ+gqR9jlGATlyC/6JtzXn36lZNb5/BbUzSjyf4B3cq8Mls0WUo7GZvOugQ==" /></div>
            ...
            <input type="hidden" name="path" id="path" value="Src/DIP/Saliency.h" />
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="tags">
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/magic3dcn/magic3d/tree/v0.4/Src/DIP/Saliency.h"
                 data-name="v0.4"
                 data-skip-pjax="true"
                 rel="nofollow"
                 class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target"
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/magic3dcn/magic3d/tree/V0.6.1/Src/DIP/Saliency.h"
                 data-name="V0.6.1"
                 data-skip-pjax="true"
                 rel="nofollow"
                 class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target"
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/magic3dcn/magic3d/tree/V0.5/Src/DIP/Saliency.h"
                 data-name="V0.5"
                 data-skip-pjax="true"
                 rel="nofollow"
                 class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target"
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/magic3dcn/magic3d/tree/ReliefFromMesh3D/Src/DIP/Saliency.h"
      ...
      <div class="actions">
        <div class="button-group">
            <a class="minibutton tooltipped tooltipped-w js-conduit-openfile-check"
               ...
               data-url="github-mac://openRepo/https://github.com/magic3dcn/magic3d?branch=master&amp;filepath=Src%2FDIP%2FSaliency.h"
               aria-label="Open this file in GitHub for Mac"
               data-failed-title="Your version of GitHub for Mac is too old to open this file. Try checking for updates.">
                <span class="octicon octicon-device-desktop"></span> Open
            </a>
                <a class="minibutton js-update-url-with-hash"
                   href="/magic3dcn/magic3d/edit/master/Src/DIP/Saliency.h"
                   data-method="post" rel="nofollow" data-hotkey="e">Edit</a>
          <a href="/magic3dcn/magic3d/raw/master/Src/DIP/Saliency.h" class="button minibutton " id="raw-url">Raw</a>
            <a href="/magic3dcn/magic3d/blame/master/Src/DIP/Saliency.h" class="button minibutton js-update-url-with-hash">Blame</a>
          <a href="/magic3dcn/magic3d/commits/master/Src/DIP/Saliency.h" class="button minibutton " rel="nofollow">History</a>
        </div><!-- /.button-group -->

            <a class="minibutton danger empty-icon"
               href="/magic3dcn/magic3d/delete/master/Src/DIP/Saliency.h"
...
<span id="L20" rel="#L20">20</span>
            ...
            <td class="blob-line-code"><div class="code-body highlight"><pre><div class='line' id='LC1'><span class="cp">#pragma once</span></div><div class='line' id='LC2'><span class="cp">#include &quot;opencv2/opencv.hpp&quot;</span></div><div class='line' id='LC3'><br/></div><div class='line' id='LC4'><span class="k">namespace</span> <span class="n">MagicDIP</span></div><div class='line' id='LC5'><span class="p">{</span></div><div class='line' id='LC6'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="k">class</span> <span class="nc">SaliencyDetection</span></div><div class='line' id='LC7'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="p">{</span></div><div class='line' id='LC8'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="nl">public:</span></div><div class='line' id='LC9'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="n">SaliencyDetection</span><span class="p">();</span></div><div class='line' id='LC10'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="o">~</span><span class="n">SaliencyDetection</span><span class="p">();</span></div><div class='line' id='LC11'><br/></div><div class='line' id='LC12'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="k">static</span> <span class="n">cv</span><span class="o">::</span><span class="n">Mat</span> <span class="n">DoGBandSaliency</span><span class="p">(</span><span class="k">const</span> <span class="n">cv</span><span class="o">::</span><span class="n">Mat</span><span class="o">&amp;</span> <span class="n">inputImg</span><span class="p">);</span></div><div class='line' id='LC13'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="k">static</span> <span class="n">cv</span><span class="o">::</span><span class="n">Mat</span> <span class="n">GradientSaliency</span><span class="p">(</span><span class="k">const</span> <span class="n">cv</span><span class="o">::</span><span class="n">Mat</span><span class="o">&amp;</span> <span class="n">inputImg</span><span class="p">);</span></div><div class='line' id='LC14'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="k">static</span> <span class="n">cv</span><span class="o">::</span><span class="n">Mat</span> <span class="n">DoGAndGradientSaliency</span><span class="p">(</span><span class="k">const</span> <span class="n">cv</span><span class="o">::</span><span class="n">Mat</span><span class="o">&amp;</span> <span class="n">inputImg</span><span class="p">);</span></div><div class='line' id='LC15'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="k">static</span> <span class="n">cv</span><span class="o">::</span><span class="n">Mat</span> <span class="n">MultiScaleDoGBandSaliency</span><span class="p">(</span><span class="k">const</span> <span class="n">cv</span><span class="o">::</span><span class="n">Mat</span><span class="o">&amp;</span> <span class="n">inputImg</span><span class="p">,</span> <span class="kt">int</span> <span class="n">wNum</span><span class="p">,</span> <span class="kt">int</span> <span class="n">hNum</span><span class="p">);</span></div><div class='line' id='LC16'><br/></div><div class='line' id='LC17'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="nl">private:</span></div><div class='line' id='LC18'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="k">static</span> <span class="kt">int</span> <span class="nf">MaxNumber</span><span class="p">(</span><span class="kt">int</span> <span class="n">n0</span><span class="p">,</span> <span class="kt">int</span> <span class="n">n1</span><span class="p">,</span> <span class="kt">int</span> <span class="n">n2</span><span class="p">);</span></div><div class='line' id='LC19'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="p">};</span></div><div class='line' id='LC20'><span class="p">}</span></div></pre></div></td>
          </tr>
        </table>
  </div>
...
<div id="jump-to-line" style="display:none">
  ...
  <div class="site-footer">
    ...
    <ul class="site-footer-links">
      <li>&copy; 2014 <span title="0.05775s from github-fe133-cp1-prd.iad.github.net">GitHub</span>, Inc.</li>
